...
/**
 * Fichier du formulaire 'TypeVehiculeType'
 * 
...
/**
 * Formulaire utilisé pour la création et l'édition d'entité 'TypeVehicule' du CRUD
 */
class TypeVehiculeType extends AbstractType
{
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        ...
        $resolver->setDefaults(array(
            'data_class' => 'BackOfficeBundle\Entity\TypeVehicule'
        ));
    }
    ...
    {
        return 'backofficebundle_typevehicule';
    }
}
