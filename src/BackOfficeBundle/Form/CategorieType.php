...
/**
 * Fichier du formulaire 'CategorieType'
 * 
...
/**
 * Formulaire utilisé pour la création et l'édition d'entité 'Categorie' du CRUD
 */
class CategorieType extends AbstractType
{
    ...
    {
        $builder->add('categorie', null, ["label" => "Catégorie"]);
    }
